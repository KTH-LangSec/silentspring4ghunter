# Comparison to GHunter on Node.js v16.13.1

## IMPORTANT

To reproduce the results you MUST use Node.js v16.13.1. Ensure that running `node --version` outputs `v16.13.1`.
...
git checkout comparison-node-16
```
...
This will produce 10 folders in the `raw-data` directory, one for each API in Table 2 of the paper.
...
The value for `Candidates:` corresponds to the "GC" value in Table 2.
