...
cd ../scripts/
npm clean-install
cp -r .fakepkg/ node_modules/fakepkg
...
echo
echo '=== Producting results for require... ==='

node gadgets.infer-properties.js
node gadgets.dynamic-analysis-require.js
node gadgets.static-analysis.js

node compare-to-ghunter.js require >../ghunter.log

mkdir ../raw-data/require
mv ../ghunter.log                            ../raw-data/require/ghunter.log
mv ../raw-data/gadgets.static-analysis.tmp   ../raw-data/require/gadgets.static-analysis.tmp
cp ../raw-data/gadgets.dynamic-analysis.csv  ../raw-data/require/gadgets.dynamic-analysis.csv
cp ../raw-data/gadgets.static-analysis.md    ../raw-data/require/gadgets.static-analysis.md
cp ../raw-data/nodejs-properties.json        ../raw-data/require/nodejs-properties.json

##

echo
echo '=== Producting results for vm.compileFunction... ==='

node gadgets.infer-properties.js
node gadgets.dynamic-analysis-vm-compile-function.js
node gadgets.static-analysis.js

node compare-to-ghunter.js vm.compileFunction >../ghunter.log

mkdir ../raw-data/vm.compileFunction
mv ../ghunter.log                            ../raw-data/vm.compileFunction/ghunter.log
mv ../raw-data/gadgets.static-analysis.tmp   ../raw-data/vm.compileFunction/gadgets.static-analysis.tmp
cp ../raw-data/gadgets.dynamic-analysis.csv  ../raw-data/vm.compileFunction/gadgets.dynamic-analysis.csv
cp ../raw-data/gadgets.static-analysis.md    ../raw-data/vm.compileFunction/gadgets.static-analysis.md
cp ../raw-data/nodejs-properties.json        ../raw-data/vm.compileFunction/nodejs-properties.json
